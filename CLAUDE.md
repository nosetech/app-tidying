...
apptidying save -o <path/to/layout.json>   # オプション指定で保存
```
...
- **デフォルト設定ファイル**: `~/.config/apptidying/settings.json`
- **ユーザー設定ディレクトリ**: `~/.config/apptidying/`
- **ログファイル**: `~/.config/apptidying/apptidying.log`
