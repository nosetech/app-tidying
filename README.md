...
詳細は [CLAUDE.md](CLAUDE.md) の「技術的な制約と対応方針」セクションを参照してください。
...
**[v1.0.0 リリースページ](https://github.com/nosetech/app-tidying/releases/tag/v1.0.0)**
